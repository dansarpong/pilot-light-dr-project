...
def lambda_handler(event, context):
    ...
    params = {
        ...
        "dr_rds_endpoint": ssm_client.get_parameter(Name="dr_rds_endpoint")['Parameter']['Value'],
        "primary_rds_endpoint": ssm_client.get_parameter(Name="primary_rds_endpoint")['Parameter']['Value'],
